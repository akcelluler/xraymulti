...
curl https://${akcell}/nginx.conf > /etc/nginx/nginx.conf
curl https://${akcell}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${akcell}/index.html1"
